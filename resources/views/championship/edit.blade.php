        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <form class="card" action="{{ route('championship.update',$championship) }}" method="POST">
            ...
            <div class="card-footer text-end">
              <button type="submit" class="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[0.8125rem] font-semibold leading-5 text-white hover:bg-indigo-500 ml-4 btn btn-primary">Editar</button>
            </div>
          </form>
